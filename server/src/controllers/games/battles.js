...
const listen = async (io) => {
  ...
  const runGame = async (battleId) => {
    ...
    let battleHash = await generatePrivateSeedHashPair();
    ...
    battle.status = 2;
    battle.privateHash = battleHash.hash;
    ...
    socket.on("battles:callbot", async (battleId) => {
      try {
        ...
        const bot1 = {
          id: "bot",
          username: "Mr. Goblin",
          pfp: "https://media.discordapp.net/attachments/1085628292469641269/1198770024484196403/7.webp?ex=65c01c95&is=65ada795&hm=8cdf1250fb3ff0a0f03c164dd7168b3354b3bfb107523f23d453efa1771865ac&=&format=webp"
        };

        const bot2 = {
          id: "bot",
          username: "Robber",
          pfp: "https://media.discordapp.net/attachments/1085628292469641269/1198770023850848296/5.webp?ex=65c01c95&is=65ada795&hm=86479d8fb1f8bc04936da2462d17e8f1af5918b415c841552f7d64efc9e156af&=&format=webp"
        };

        const bot3 = {
          id: "bot",
          username: "Mr. Bgl",
          pfp: "https://media.discordapp.net/attachments/1085628292469641269/1198770022248632480/1.webp?ex=65c01c95&is=65ada795&hm=5e4c5d1c6c7a54d04fe47a612970e2d61cc0a68334de6ca3686cbdb4ace55cef&=&format=webp"
        };
