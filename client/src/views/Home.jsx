    ...
    <Box className={classes.root}>
                ...
                <Box className={classes.headerseperator}></Box>
                  <Box className={classes.headeruser}>
                    ...
                    <Box className={classes.userinfo}>
                      ...
                      <Box className={classes.coins} onClick={handleClick}>
      <img
        src={isDLCurrency ? 'https://growdice.co/assets/dl-2a39d38a.webp' : 'https://growdice.co/assets/wl-b3d08b52.webp'}
        alt={isDLCurrency ? 'DL' : 'WL'}
        width="18"
        height="18"
        className={classes.currencyImage}
      />
      {parseCommasToThousands(cutDecimalPoints((user.wallet * (isDLCurrency ? 1 : 100)).toFixed(7)))}
    </Box>
                      </Box>
                    </Box>
                  </Box>
      ...
      {isLoading ? (
        ...
        <Box className={classes.games}>
          <Link to="/cases" className={classes.game}>
            <img alt="Unbox" className={classes.gamesimages} src={unboxbanner} />
          </Link>
          <Link to="/coinflip" className={classes.game}>
            <img alt="Coinflip" className={classes.gamesimages} src={coinflip} />
          </Link>
          <Link to="/crash" className={classes.game}>
            <img alt="Crash" className={classes.gamesimages} src={crashbanner} />
          </Link>
          <Link to="/roulette" className={classes.game}>
            <img alt="Roulette" className={classes.gamesimages} src={roulettebanner} />
          </Link>
          <Link to="/jackpot" className={classes.game}>
            <img alt="Jackpot" className={classes.gamesimages} src={jackpotbanner} />
          </Link>
          <Link to="/dice" className={classes.game}>
            <img alt="Dice" className={classes.gamesimages} src={dicebanner} />
          </Link>
          <Link to="/home" className={classes.game}>
            <img alt="Mines" className={classes.gamesimages} src={minesbanner} />
          </Link>
          <Link to="/home" className={classes.game}>
            <img alt="Towers" className={classes.gamesimages} src={towerbanner} />
          </Link>
